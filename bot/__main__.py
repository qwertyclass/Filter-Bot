...
PM_START_TEXT = """
*Hello* *{}*
*My name is* *{}*\n\n`😞 Sorry Bruh This Bot Can Be Only Used in Cinema _
"""
...
def send_start(bot, update):
    ...
    keyboard = [[InlineKeyboardButton(text="♻️ Group",url="https://t.me/https://t.me/joinchat/T_yIME8RMB-AO9Xx"),InlineKeyboardButton(text="🔰 Channel",url="https://t.me/joinchat/Rh44PcxBE6HYusJ1")]]
...
def get_help(bot: Bot, update: Update):
    ...
    if chat.type != chat.PRIVATE:
        ...
        update.effective_message.reply_text("Contact me in PM to get the list of possible commands.",
                                            reply_markup=InlineKeyboardMarkup(
                                                [[InlineKeyboardButton(text="⚙️Help",url="t.me/{}?start=help".format(bot.username))],  
                                                [InlineKeyboardButton(text="😴Contact Creator",url="https://t.me/Qwertyclass")]]))
        return
